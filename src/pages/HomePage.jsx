...
import { faUser, faBolt, faBook } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        ...
        <div className="relative flex flex-row flex-wrap items-center justify-around md:text-left">
          ...
          <div className="flex relative m-8 mt-40 mb-4 md:mt-8 md:m-24">
            <img
              src="/src/assets/michael.jpeg"
              alt="Michael Vadney"
              className="w-80 h-80 rounded-full object-cover outline-10 outline-secondary z-25"
            />
            <div className="absolute -top-6 -left-6 w-24 h-24 bg-secondary-dark rounded-full"></div>
            <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-secondary-dark rounded-full"></div>
          </div>
          {/* Author Text */}
          <div className="w-1/2 flex-1 space-y-6 text-center" data-aos="fade-left">
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold text-gray-900 leading-tight">
              <span className="block mb-2 animate-slide-in-left">Michael Vadney</span>
            </h1>
                    ...
                    <div className="lg:col-span-4 text-center lg:text-left space-y-6">
                      <div className="space-y-4">
                        ...
                        <p className="text-xl text-gray-600 leading-relaxed max-w-3xl">
                          In the fight for power, justice, and survival, everyone must decide who they will become. An epic tale of kingdoms
                          in turmoil, where ancient magic meets political intrigue, and heroes are forged in the crucible of war.
                        </p>
                      </div>
                  ...
                  <div className="grid lg:grid-cols-5 gap-12 items-center">
                    <div className="lg:col-span-4 text-center lg:text-left space-y-6 order-2 lg:order-1">
                      <div className="space-y-4">
                        ...
                        <p className="text-xl text-gray-600 leading-relaxed max-w-3xl lg:ml-auto">
                          A thrilling adventure through time where past and future collide in unexpected ways. When reality itself becomes
                          unstable, our heroes must navigate the streams of time to prevent the unraveling of existence.
                        </p>
                      </div>
                      <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                    ...
                    <div className="lg:col-span-1 order-1 lg:order-2">
                      <div className="w-48 h-72 mx-auto bg-gradient-to-br from-slate-600 via-gray-700 to-slate-800 rounded-2xl shadow-2xl flex items-center justify-center transform group-hover:-rotate-3 transition-transform duration-500">
                        <FontAwesomeIcon icon={faBolt} className="text-white text-6xl" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="text-gray-900 animate-fade-in-up">
                ...
                <p className="text-gray-600 mb-12 leading-relaxed text-lg">
                  Every episode dives deep into the challenges, victories, and everything in between on the path to becoming a published
              ...
              <div className="relative animate-scale-in">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-10 shadow-2xl border border-gray-200">
                  ...
                  <h4 className="text-2xl font-bold text-gray-900 mb-4">The Reality of Being an Indie Author</h4>
      ...
      <section className="py-32 bg-gray-50">
        <div className="max-w-6xl mx-auto px-8 lg:px-16 text-center">
          <div className="animate-fade-in-up">
            <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-8">Stay Connected</h2>
